...
const modalContentStyles = tv({
  base: [
    'max-h-full w-full rounded-t-2xl ring-1 ring-dark/5 bg-overlay dark:bg-accent text-overlay-fg text-left align-middle shadow-lg',
      ...
      >
        {(values) => (
          <Dialog role={role}>
            ...
            {closeButton && <Dialog.CloseIndicator close={values.state.close} isDismissable={true} />}
          </Dialog>
        )}
      </ModalPrimitive>
    </ModalOverlayPrimitive>
