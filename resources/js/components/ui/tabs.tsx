...
const tabListStyles = tv({
  ...
  variants: {
    orientation: {
      horizontal: 'flex-row gap-x-4 border-b border-border',
...
const tabStyles = tv({
  base: [
    'relative flex whitespace-nowrap cursor-default items-center  flex-1 items-center justify-center  text-sm font-medium outline-none transition hover:text-fg [&>[data-slot=icon]]:size-4 [&>[data-slot=icon]]:mr-2',
    // hor
    ...
    // ver
    'group-orientation-horizontal:p-3 rounded-md'
  ],
  variants: {
    isSelected: {
      false: 'text-muted-fg ',
      true: 'text-fg bg-secondary'
    },
