...
const avatarStyles = tv({
  base: ['  !outline-1 overflow-hidden'],
  variants: {
    size: {
      'extra-small': 'size-5',
      small: 'size-6',
...
const AvatarUploadPreview = ({
  ...
  return (
    <span aria-labelledby={ariaLabelledby} {...props} className={avatarStyles({ shape, size, className })}>
      {initials && (
        <svg
      ...
      {src && <img src={src} className="object-cover object-center w-full h-full" alt={alt} />}
...
export { AvatarGroup, AvatarUploadPreview };
