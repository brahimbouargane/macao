...
function BlogShow({ post, relatedPosts }) {
  ...
  const formatContent = (content) => {
    // Style words/phrases before colons as bold and blue
      ...
      <motion.div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto px-4  ml-10 ">
          ...
          >
            <motion.h1
              variants={fadeInUp}
              className="text-5xl uppercase  font-bold font-banner tracking-tight md:text-7xl text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] [text-shadow:_0_1px_0_rgb(0_0_0_/_40%),_0_2px_15px_rgb(255_255_255_/_30%)] leading-tight"
            >
          ...
          {isRecipe ? (
            ...
            <div className="article-content">
              {post.content && (
                <>
                  <h1 className="text-3xl md:text-4xl font-bold text-red-700 mb-6">{post.title}</h1>
                  <article className="prose prose-lg max-w-7xl text-justify mx-auto text-gray-800">
        ...
        <div className="mt-16 rounded-[80px] overflow-hidden">
          <div className="bg-red-700 text-white flex flex-col md:flex-row items-center">
            ...
            <div className="p-8 md:p-12 md:w-1/2">
              ...
              <p className="mb-6">
                Pastor Macao propose une gamme variée de produits chocolatés et de confiseries pour satisfaire toutes
