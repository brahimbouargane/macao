...
export function CategoriesDataTable<TData, TValue>({ columns, data, pd,translations }: DataTableProps<TData, TValue>) {
                                    ...
                                    >
                                        {row.getVisibleCells().map((cell) => (
                                            <TableCell
                                                ...
                                                className={cn(
                                                    '!pl-4  border-2 ',
                                                    row.getIsSelected() && '  !border-l-colors-primary-500'
                                                )}
                                            >
