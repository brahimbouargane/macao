    ...
    return (
        <Card className="flex flex-col">
            ...
            <Card.Content className="flex-1 pb-0">
                <Chart className="min-h-[200px] max-h-[200px] mx-auto aspect-square w-full" config={config}>
                    <PieChart>
                                        ...
                                        return (
                                            ...
                                            >
                                                <tspan
                                                    x={viewBox.cx}
                                                    y={viewBox.cy}
                                                    className="text-3xl font-bold fill-fg"
                                                >
            ...
            <Card.Footer className="flex-col gap-2 text-sm">
                ...
                <div className="leading-none text-muted-fg">Showing total subscribers for the last 3 months</div>
            </Card.Footer>
        </Card>
    );
}
