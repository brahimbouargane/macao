...
//     return (
//         <div className="flex items-center justify-between p-4 px-6 max-md:flex-col max-md:gap-y-4">
//             {/* Selected rows */}
//             <div className="text-sm text-muted-foreground">
...
//                     <TooltipWrapper content={__('Go to first page')}>
//                         <Button
//                             appearance="outline"
...
//                     <TooltipWrapper content={__('Go to previous page')}>
//                         <Button
//                             appearance="outline"
//                             className="w-8 h-8 p-0"
...
//                         Page {table.getState().pagination.pageIndex + 1} {__('of')} {table.getPageCount()}
//                     </div>
//                     <TooltipWrapper content={__('Go to next page')}>
//                         <Button
//                             appearance="outline"
//                             className="w-8 h-8 p-0"
...
//                     <TooltipWrapper content={__('Go to last page')}>
//                         <Button
//                             appearance="outline"
//                             className="w-8 h-8 p-0 "
