...
export const columns: ColumnDef<UserData>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const image: string = row.original.avatar ?? '/images/avatar-placeholder.svg';
            return (
                <div className="flex ">
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="flex items-center">
                    {date ? <Badge intent="success">{date}</Badge> : <Badge intent="danger">{__(translations,'Unverified')}</Badge>}
                </div>
            );
        }
    },
