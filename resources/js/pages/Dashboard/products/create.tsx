...
function Create({ categories }: CreateCategoryProps) {
  ...
  return (
    <>
      <Head title={__(translations, 'Create') + ' ' + __(translations, 'Products')} />

      {/* <DashboardBreadCrumbs /> */}
      <Container className="p-6 max-w-screen">
        {/* <DashboardBreadCrumbs resource="Products" /> */}
        <div className="flex items-center justify-between py-4">
          <h1 className="text-2xl"> {__(translations, 'Create') + ' ' + __(translations, 'Product')}</h1>
        </div>
