...
import { BrandData, CategoryData, PagePropsData, PaginationData } from '@/types';
...
function Index({ paginationData, categories, brands }: ProductsIndexPage) {
  ...
  return (
    <>
      ...
      <QueryBuilderProvider builder={builder} categories={categories} brands={brands}>
